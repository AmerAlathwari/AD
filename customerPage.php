...
<!-- header top section -->
  <header id="header">
    <div class="header-content clearfix"> <a class="logo" href="customerPage.php"><img src="images/logo.png" alt="Home" width="50" height="50"></a>
	  <nav class="navigation" role="navigation">
			<ul class="primary-nav">
				<li><a href="#" title="Login Email"><?php echo "Your Email Is: ". "<i><b>".$login_session."</b></i>" ;?> </span></a></li>
