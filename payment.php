    ...
    include ("./header.php")
			    ...
			    <div id="kcontent">
                    <h1>Payment Method</h1>
                        ...
                        <table>	
                                ...
                                <form id="formElem" name="formElem"  action="payment_process.php" method="POST" class="myForm">
                                <th colspan="3"><h2 align="center">PAYMENT DETAILS</h2> </th> 
                            <tr>
								<td>  
								...
								<td>  
                                    ...
                                    <input id="email" name="email" placeholder="xxx@gmail.com" type="text" AUTOCOMPLETE=OFF />
                                </td>
                            </tr>
                            <tr>
								<td>  
								...
								<td> 
                                    ...
                                    <input id="address" name="address" placeholder="Insert here.." type="text" AUTOCOMPLETE=OFF />
                                </td>
                            </tr>
                            <tr>
								<td>
								...
								<td>
                                    ...
                                    <input id="city" name="city" placeholder="Insert here.." type="text" AUTOCOMPLETE=OFF />
                                </td>
                            </tr>
                            <tr>
								<td>
								    <label for="Address">Phone</label>
                                    <input id="phone" name="phone" placeholder="Insert here.." type="text" AUTOCOMPLETE=OFF />
                                </td>
                            ...
                            <tr>
								<td>
                                <label for="phone">Delivery Type</label>
                                    <select id="delivery" name="delivery">
                                        <option value="PickUp" countrynum="PickUp">Pick-Up</option>   
                                    </select>   
                                    </td>
                                ...
                                <?php
                                    ...
                                    if(isset($_SESSION["cart_session"]))
                                    {
                                        ...
                                        echo ' <p> <label for="Address">Total Amount: RM</label> <input id="paid" class="tAmount" name="Totalka"  value=" '.$total.'"  type="text"  readonly></p>';
                            ...
                            <tr>
                                <td>
                                    <p>
                                    Dear Value Customer, you can click the button 'Proceed to Payment' to order your items.
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="submit">
                                    <button id="payment" type="submit" class="a-btn"  name="submit"  title="Click On Payment Method">Proceed</button>
                                </td>
                            </tr>
                        </form>
                    </table>
		...
		<script type="text/javascript">
			...
			var element = $(this);
			 ...
			 if(confirm("Your payment has successful."))
					  {
